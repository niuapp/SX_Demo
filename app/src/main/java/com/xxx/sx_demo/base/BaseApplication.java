...
public class BaseApplication extends Application {
    ...
    //主页Fragment缓存集合
    private static HashMap<String, BaseFragment> mMainFragments;
...
//                .addInterceptor(new LoggerInterceptor("TAG"))
        ...
        mMainFragments = new HashMap<String, BaseFragment>();//主页Fragment缓存
    }
     ...
     * @return
     */
    public static HashMap<String, BaseFragment> getmMainFragments() {
